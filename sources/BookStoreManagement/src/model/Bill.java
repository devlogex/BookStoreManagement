...
public class Bill {
    ...
    public Bill(){}
    public Bill(String id, String customerID, Date date,float value,float moneyReceive, float moneyChange,String bookID,int count,float price,float moneyBook)
    {
        this.id=id;
